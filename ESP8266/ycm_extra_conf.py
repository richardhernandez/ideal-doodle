...
# These are all of the includes we use for Syntastic
with open('.syntastic_cpp_config', 'r') as syntastic_config:
    includes = [line.strip('\n') for line in syntastic_config]
...
def IsExampleFile( filename ):
    fullpath = os.path.splitext(filename)[1]
    return 'example' in fullpath
